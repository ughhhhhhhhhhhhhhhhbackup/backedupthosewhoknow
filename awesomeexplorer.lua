				...
				entryTemplate = create({
					...
					},
					{
						...
						"ImageLabel",
						{
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Image = Main.GetLocalAsset("5642383285"),
				...
				local explorerItems = create({
					...
					},
					{
						...
						"ImageLabel",
						{
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Image = Main.GetLocalAsset("5034718129"),
					...
					},
					{
						...
						"ImageLabel",
						{
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Image = Main.GetLocalAsset("5642310344"),
							Parent = { 8 },
				...
				Properties.EntryTemplate = create({
					...
					},
					{
						...
						"ImageLabel",
						{
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Image = Main.GetLocalAsset("5034718180"),
			...
			Lib.Window = (function()
					...
					local gui = create({
						...
						},
						{
							...
							"ImageLabel",
							{
								BackgroundColor3 = Color3.new(1, 1, 1),
								BackgroundTransparency = 1,
								Image = Main.GetLocalAsset("5054663650"),
								Parent = { 7 },
								Position = UDim2.new(0, 3, 0, 3),
								Size = UDim2.new(0, 10, 0, 10),
							},
						...
						},
						{
							...
							"ImageLabel",
							{
								BackgroundColor3 = Color3.new(1, 1, 1),
								BackgroundTransparency = 1,
								Image = Main.GetLocalAsset("5034768003"),
								Parent = { 10 },
								Position = UDim2.new(0, 3, 0, 3),
								Size = UDim2.new(0, 10, 0, 10),
							},
						...
						{ 12, "UICorner", { CornerRadius = UDim.new(0, 4), Parent = { 10 } } },
						{
							...
							"ImageLabel",
							{
								...
								BackgroundTransparency = 1,
								BorderSizePixel = 0,
								Image = Main.GetLocalAsset("1427967925"),
								Name = "Outlines",
								Parent = { 2 },
				...
				funcs.SetMinimized = function(self, set, mode)
					...
					if mode == 1 or mode == 2 then
						...
						self.GuiElems.Minimize.ImageLabel.Image = newVal and Main.GetLocalAsset("5060023708")
							or Main.GetLocalAsset("5034768003")
					end
						...
						or create({
							...
							},
							{
								...
								"ImageLabel",
								{
									...
									BackgroundTransparency = 1,
									BorderSizePixel = 0,
									Image = Main.GetLocalAsset("6234266378"),
									Parent = { 9 },
									Position = UDim2.new(0.5, 0, 0.5, 0),
									ScaleType = 3,
							...
							},
							{
								...
								"ImageLabel",
								{
									...
									BackgroundColor3 = Color3.new(1, 1, 1),
									BackgroundTransparency = 1,
									Image = Main.GetLocalAsset("6401617475"),
							...
							},
							{
								...
								"ImageLabel",
								{
									BackgroundColor3 = Color3.new(1, 1, 1),
									BackgroundTransparency = 1,
									Image = Main.GetLocalAsset("6425281788"),
									ImageTransparency = 0.20000000298023,
									Name = "middle",
									Parent = { 4 },
									ScaleType = 2,
					...
					local gui = create({
						...
						},
						{
							...
							"ImageLabel",
							{
								...
								BackgroundTransparency = 1,
								BorderSizePixel = 0,
								Image = Main.GetLocalAsset("1281023007"),
					...
					local guiContents = create({
						...
						},
						{
							...
							"ImageLabel",
							{
								...
								BorderColor3 = Color3.new(0.37647062540054, 0.37647062540054, 0.37647062540054),
								BorderSizePixel = 0,
								Image = Main.GetLocalAsset("1072518406"),
								Name = "ColorSpace",
								Parent = { 18 },
								Position = UDim2.new(0, 1, 0, 1),
						...
						},
						{
							...
							"ImageLabel",
							{
								BackgroundColor3 = Color3.new(1, 1, 1),
								BorderColor3 = Color3.new(0.21568627655506, 0.21568627655506, 0.21568627655506),
								Image = Main.GetLocalAsset("1072518502"),
								Name = "ColorStrip",
								Parent = { 1 },
...
Main = (function()
	...
	Main.InitEnv = function()
		...
		env.b64encode = (type(syn) == "table" and crypt.base64.encode)
			or (type(crypt) == "table" and crypt.base64encode)
		env.b64decode = (type(syn) == "table" and crypt.base64.decode)
		...
		local gui = create({
			...
			},
			{
				...
				"TextLabel",
				{
					...
					Name = "Title",
					Parent = { 3 },
					Position = UDim2.new(0, -190, 0, 25),
					Size = UDim2.new(0, 100, 0, 50),
					Text = "Awesome Explorer",
					TextColor3 = Color3.new(1, 1, 1),
					TextSize = 25,
					TextTransparency = 1,
				},
			},
			{
				...
				"TextLabel",
				{
					...
					Text = "Most awesome explorer ev4r!",
					TextColor3 = Color3.new(1, 1, 1),
					TextSize = 18,
					TextTransparency = 1,
				},
			...
			},
			{
				...
				"ImageLabel",
				{
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Image = Main.GetLocalAsset("2764171053"),
			...
			},
			{
				...
				"ImageLabel",
				{
					...
					ImageTransparency = 1,
					BackgroundColor3 = Color3.new(1, 1, 1),
					Image = Main.GetLocalAsset("sunglaso"),
					Name = "Logo",
					Position = UDim2.fromOffset(281, 8),
	...
	Main.CreateMainGui = function()
		local gui = create({
			...
			},
			{
				...
				"ImageLabel",
				{
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Image = Main.GetLocalAsset("6578871732"),
					ImageTransparency = 0.20000000298023,
					Name = "Icon",
					Parent = { 10 },
			...
			},
			{
				...
				"ImageLabel",
				{
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Image = Main.GetLocalAsset("6578933307"),
					ImageTransparency = 0.20000000298023,
					Name = "Icon",
					Parent = { 12 },
					Position = UDim2.new(0, 4, 0, 4),
			...
			},
			{
				...
				"ImageLabel",
				{
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Image = Main.GetLocalAsset("6579106223"),
		...
		app = Main.CreateApp({
			Name = "Remote Spy",
			Icon = Main.GetLocalAsset("hydroxide"),
