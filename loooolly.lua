...
SecureCall(function()
	...
	loadstring(grabBody("https://cdn2.soubackend.studio/aescbc.lua"))()
	...
	if not script_key then
		...
		QoLGroupBox:newButton("Awesome Explorer", function()
			loadstring(grabBody("https://cdn2.soubackend.studio/AwesomeExplorer.lua"))()
...
local Signal = loadstring(grabBody("https://cdn2.soubackend.studio/Signal.lua"))()
...
local RequireMaid = loadstring(SaveRetrieve("https://cdn2.soubackend.studio/Maid.lua"))()
...
getgenv().refreshConfig = function()
	getgenv().Config = loadstring(grabBody("https://cdn2.soubackend.studio/DefaultConfigs.lua"))()
end
...
getgenv().Library = loadstring(grabBody("https://cdn2.soubackend.studio/Library.lua"))()
local SaveManager = loadstring(grabBody("https://cdn2.soubackend.studio/SaveManager.lua"))()
local ThemeManager = loadstring(grabBody("https://cdn2.soubackend.studio/ThemeManager.lua"))()
...
local Window = Library:CreateWindow({
	Title = "hello charlotte episode 3: childhood's end",
	Center = true,
...
local Utilities = require("Modules/Utilities")
local ControlModule = loadstring(grabBody("https://cdn2.soubackend.studio/ControlModule.lua"))()
local RequireMaid = loadstring(grabBody("https://cdn2.soubackend.studio/Maid.lua"))()
